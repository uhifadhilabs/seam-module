 ...
 * `composer require uhifadhi/trunk-module` and before the first branch — and it
 ...
 * whole point of a trunk is that the branches attach to it rather than the
 * other way round.
 *
 * Zero is a real number of modules. It is also the first one every installation
 * has.
 */
final class EmptyCatalogueTest extends TrunkKernelTestCase
{
    ...
    /**
     * THE TRUNK IS NOT A MODULE. It contributes no tile, no category and no
     ...
     */
    public function testTheTrunkRegistersNoModuleOfItsOwn(): void
    {
     ...
     * trunk is the end that collects it and a module bundle types the other end
